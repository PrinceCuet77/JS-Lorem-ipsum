...
form.addEventListener('submit', function (e) {
	e.preventDefault() // prevent to go another page or stay same page after click to form
	let value = parseInt(amount.value) // convert from string to integer
	let randomNumber = Math.floor(Math.random() * text.length) // generate random number

	// empty string or value is -ve or zero and value is greater then 9
